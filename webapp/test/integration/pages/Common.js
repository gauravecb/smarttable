sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/table/smart/app", ".html");
		...
		return Opa5.extend("com.table.smart.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/table/smart/localService/mockserver"], function (mockserver) {
